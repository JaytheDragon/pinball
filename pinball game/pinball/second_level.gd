...
@onready var expeditionEnd = $ExpeditionEnd_2
@onready var ball = $Ball_2
...
func _process(delta):
	...
	if GameState.check_win_condition_2():
		get_tree().change_scene_to_file("res://level_two_clear.tscn")
...
func _on_expedition_end_2_pressed() -> void:
	get_tree().change_scene_to_file("res://lose.tscn")
